...
public class Test extends Activity {
    ...
    AdapterView.OnItemClickListener mItemClickListener = new AdapterView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView parent, View view, int position, long id) { //게임 선택
            ...
            if(conn != null){
                ...
                if(type == 1){
                    ...
                    */
                    ...
                    Log.i("dis", "connected");
                    return "success";
                } else if(type == 8){   //send reply
                    buffer.append("command=sendReply&g_no=1_1429111200&memberNumber=4&contents=").append("");
                    OutputStream out = new BufferedOutputStream(conn.getOutputStream());
                    out.write(buffer.toString().getBytes());
                    out.flush();
